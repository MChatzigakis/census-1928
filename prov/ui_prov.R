...
map<-st_read('prov.shp')

map<-ms_simplify(map)

data<-read.xlsx('prov.xlsx')
...
sidebar <- dashboardSidebar(  
  ...
  div(id = "menu",
      ...
      br(),
      div(style = 'margin-left:15px',
          span(style = 'color:white; font-weight: bold; font-size:14px', 'Πληθυσμός: 6,204,684')),
      br(),
      div(style = 'margin-left:30px',
          span(style = 'color:white; font-weight: bold; font-size:14px', HTML(paste0('&#9654;&nbsp;&nbsp;Γηγενείς: 4,982,940')))),
      br(),
      div(style = 'margin-left:30px; margin-bottom:12px',
          span(style = 'color:white; font-weight: bold; font-size:14px', HTML(paste0('&#9654;&nbsp;&nbsp;Πρόσφυγες: 1,221,744')))),
      div(style = 'margin-left:45px; margin-bottom:10px',
          span(style = 'color:white; font-weight: bold; font-size:14px', HTML(paste0('&#9632;&nbsp;&nbsp;Μετά το 1922: 1,069,957')))),
      div(style = 'margin-left:45px',
          span(style = 'color:white; font-weight: bold; font-size:14px', HTML(paste0('&#9632;&nbsp;&nbsp;Πριν το 1922: 151,787')))),
      br(),
      selectInput(inputId = "input_variable", 
                  label = tags$span(style="color:white; font-weight: bold","Μεταβλητή"), 
                  choices = c("Πληθυσμός", "Πληθυσμός Προσφύγων 1928", "Ποσοστό Προσφύγων 1928", 
                              "Πληθυσμός Προσφύγων μετά το 1922", "Ποσοστό Προσφύγων μετά το 1922",
                              "Πληθυσμός Προσφύγων πριν το 1922", "Ποσοστό Προσφύγων πριν το 1922"), 
                  selected ="Πληθυσμός", selectize = FALSE),
      selectInput(inputId = "input_gender", 
                  label = tags$span(style="color:white; font-weight: bold","Φύλο"), 
                  choices = c("Σύνολο", "Άνδρες", "Γυναίκες"), 
                  selected ="Σύνολο", selectize = FALSE),
      div(
      ...
      div(style = "margin-left: 15px;", HTML("<a href=\"census1928_prov.zip\" <i class='fa-solid fa-download' style='font-size: 1.5em; margin-bottom: 0.5em; position: absolute; bottom: 0;' title='Download map data'></i> </a>
